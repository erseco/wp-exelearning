...
| PUT | `/api/v2/projects/:id` | Update project metadata |
| DELETE | `/api/v2/projects/:id` | Delete project |
| GET | `/api/v2/projects/:id/yjs-document` | Get Yjs document state |
| POST | `/api/v2/projects/:id/yjs-document` | Store Yjs update |
| POST | `/api/v2/projects/:id/snapshot` | Force create snapshot |
| POST | `/api/v2/projects/:id/collaborators` | Add collaborator |
| DELETE | `/api/v2/projects/:id/collaborators/:id` | Remove collaborator |
| POST | `/api/v2/projects/:id/assets` | Upload asset |
| GET | `/api/v2/projects/:id/assets` | List assets |
| GET | `/api/v2/projects/:id/assets/:assetId` | Download asset |
