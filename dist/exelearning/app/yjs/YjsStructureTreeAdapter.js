...
class YjsStructureTreeAdapter {
  ...
  initialize() {
    ...
    console.log('[YjsStructureTreeAdapter] Initialized');
  }
  ...
  movePageToParent(pageId, newParentId) {
    ...
    try {
      ...
      console.log(`[YjsStructureTreeAdapter] Moved page ${pageId} under ${newParentId}`);
    } finally {
      this._isUpdating = false;
      this.renderTree();
    }
  ...
  addPage(parentId = null, pageName = 'New Page') {
    ...
    try {
      ...
      console.log(`[YjsStructureTreeAdapter] Added page: ${page.id}`);
      return page;
    } finally {
      this._isUpdating = false;
      this.renderTree();
  ...
  renamePage(pageId, newName) {
    ...
    try {
      ...
      console.log(`[YjsStructureTreeAdapter] Renamed page ${pageId} to "${newName}"`);
    } finally {
      this._isUpdating = false;
      this.renderTree();
    }
  ...
  deletePage(pageId) {
    ...
    try {
      ...
      console.log(`[YjsStructureTreeAdapter] Deleted page ${pageId}`);
  ...
  destroy() {
    ...
    this._observers = [];
    console.log('[YjsStructureTreeAdapter] Destroyed');
  }
}
