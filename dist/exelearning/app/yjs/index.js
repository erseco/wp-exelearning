...
window.YjsModules = {
  ...
  async initializeProject(projectId, authToken, options = {}) {
    console.log('[YjsModules] Initializing project:', projectId);
    ...
    this._bridge = bridge;
    console.log('[YjsModules] Project initialized successfully');
  ...
  async cleanup() {
    ...
    console.log('[YjsModules] Cleanup complete');
  },
...
// Log availability
console.log('[eXeLearning] Yjs modules loaded:', Object.keys(window.YjsModules).filter(k => !k.startsWith('_')));
