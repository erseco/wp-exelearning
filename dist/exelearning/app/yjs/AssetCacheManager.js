...
class AssetCacheManager {
  ...
  async cacheAsset(assetId, blob, metadata = {}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        console.log(`[AssetCacheManager] Cached asset ${assetId} (${blob.size} bytes)`);
        resolve();
      };
      request.onerror = () => reject(request.error);
    });
  ...
  async resolveAssetUrl(assetPath) {
    ...
    if (cached && cached.blob) {
      ...
      console.log(`[AssetCacheManager] Resolved ${normalizedPath} -> blob URL`);
      return url;
    }
  ...
  async preloadAllAssets() {
    ...
    console.log(`[AssetCacheManager] Preloaded ${count} assets as blob URLs`);
    return count;
  }
  ...
  async deleteAsset(assetId) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        console.log(`[AssetCacheManager] Deleted cached asset ${assetId}`);
        resolve();
      };
      request.onerror = () => reject(request.error);
    });
  ...
  async clearCache() {
    ...
    return new Promise((resolve, reject) => {
      ...
      tx.oncomplete = () => {
        console.log(`[AssetCacheManager] Cleared ${deleted} assets from cache`);
        resolve();
      };
  ...
  async pruneIfNeeded() {
    ...
    console.log(`[AssetCacheManager] Cache size (${size}) exceeds max, pruning...`);
  ...
  destroy() {
    ...
    console.log('[AssetCacheManager] Destroyed');
  }
}
