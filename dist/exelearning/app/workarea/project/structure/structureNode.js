export default class StructureNode {
    ...
    async createViaYjs() {
        try {
            ...
            if (page) {
                ...
                console.log('[StructureNode] Created page via Yjs:', page.id);
    ...
    async cloneViaYjs() {
        try {
            ...
            if (clonedPage) {
                console.log('[StructureNode] Cloned page via Yjs:', clonedPage.id);
                return {
                    responseMessage: 'OK',
                    odeNavStructureSync: {
                        id: clonedPage.id,
    ...
    async renameViaYjs(newName) {
        try {
            ...
            if (success) {
                console.log('[StructureNode] Renamed page via Yjs:', this.id);
                return {
                    responseMessage: 'OK',
                    odeNavStructureSync: {
                        id: this.id,
    ...
    async removeViaYjs() {
        try {
            ...
            if (success) {
                console.log('[StructureNode] Removed page via Yjs:', pageId);
                return { responseMessage: 'OK' };
            } else {
                throw new Error('Failed to remove page via Yjs');
            }
        } catch (error) {
    ...
    async updateParentViaYjs(parentId, newOrder) {
        ...
        try {
            ...
            console.log('[StructureNode] Updated parent via Yjs:', this.id, '->', parentId);
            return true;
        } catch (error) {
    ...
    async updateOrderViaYjs(newOrder) {
        ...
        try {
            ...
            console.log('[StructureNode] Updated order via Yjs:', this.id, '->', this.order);
            return true;
        } catch (error) {
    ...
    async savePropertiesViaYjs(properties) {
        try {
            ...
            if (success) {
                console.log('[StructureNode] Saved properties via Yjs:', this.id);
    ...
    loadPropertiesFromYjs() {
        ...
        if (yjsProperties) {
            ...
            console.log('[StructureNode] Loaded properties from Yjs:', this.id);
        }
    }
