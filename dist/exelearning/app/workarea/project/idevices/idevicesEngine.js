...
export default class IdevicesEngine {
    ...
    syncNewIdeviceToYjs(ideviceNode) {
        ...
        if (componentId) {
            ...
            console.log(`[IdevicesEngine] Synced iDevice to Yjs: ${componentId} (type: ${ideviceTypeName})`);
        }
    }
    ...
    async renderRemoteIdevice(componentData, pageId, blockId) {
        ...
        console.log(`[IdevicesEngine] Rendering remote iDevice: ${componentData.id}`, componentData);
        ...
        console.log(`[IdevicesEngine] Remote iDevice rendered: ${componentData.id}`);
    }
    ...
    async updateRemoteIdeviceContent(componentData) {
        ...
        console.log(`[IdevicesEngine] Updating remote iDevice content: ${componentData.id}`);
        ...
        console.log(`[IdevicesEngine] Remote iDevice content updated: ${componentData.id}`);
    }
    ...
    setNodeContentPageTitle(pageIdOrProperties) {
        ...
        console.log('[IdevicesEngine] setNodeContentPageTitle - props:', props);
        console.log('[IdevicesEngine] setNodeContentPageTitle - hidePageTitle:', hidePageTitle, '(raw:', props.hidePageTitle, ')');

        if (hidePageTitle) {
            console.log('[IdevicesEngine] Hiding page title');
    ...
    initPagePropertiesObserver(pageId) {
        ...
        this._pagePropertiesObserver = (events, transaction) => {
            ...
            if (shouldUpdate) {
                ...
                console.log('[IdevicesEngine] Remote page properties changed:', currentProps);
                console.log('[IdevicesEngine] hidePageTitle:', currentProps?.hidePageTitle, typeof currentProps?.hidePageTitle);
                this.setNodeContentPageTitle(this._observedPageId);
            }
        };

        pageMap.observeDeep(this._pagePropertiesObserver);
        console.log('[IdevicesEngine] Page properties observer initialized for:', pageId);
    }
    ...
    loadScriptDynamically(path, newVersion) {
        ...
        console.log('[iDevice] Loading script:', script.src);
        ...
        script.onload = () => {
            console.log('[iDevice] Script loaded successfully:', script.src);
        };
