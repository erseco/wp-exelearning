        ...
        if (project._yjsBridge) {
            ...
            if (documentManager) {
                ...
                if (initialTitle) {
                    ...
                    this.checkTitleLineCount();
                    console.log('[OdeTitleMenu] Loaded initial title from Yjs:', initialTitle);
                }
                ...
                console.log('[OdeTitleMenu] Yjs title binding initialized');
            }
        }
    }
    ...
    onRemoteTitleChange(newTitle) {
        ...
        if (!this.titleContainer.classList.contains('title-editing')) {
            if (this.odeTitleMenuHeadElement.textContent !== title) {
                ...
                this.checkTitleLineCount();
                console.log('[OdeTitleMenu] Remote title update:', title);
            }
        }
        ...
        try {
            ...
            if (project._yjsBridge) {
                ...
                if (documentManager) {
                    ...
                    console.log('[OdeTitleMenu] Saved title to Yjs:', title);
