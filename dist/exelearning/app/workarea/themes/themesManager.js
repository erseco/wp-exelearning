...
export default class ThemesManager {
        ...
        if (project?._yjsBridge) {
            ...
            if (documentManager) {
                ...
                if (initialTheme && initialTheme !== this.selected?.id) {
                    ...
                    console.log('[ThemesManager] Loaded initial theme from Yjs:', initialTheme);
                }
                ...
                console.log('[ThemesManager] Yjs theme binding initialized');
            }
        }
    }
    ...
    async onRemoteThemeChange(themeId) {
        console.log('[ThemesManager] Remote theme change:', themeId);
    ...
    saveThemeToYjs(themeId) {
        ...
        if (project?._yjsBridge) {
            ...
            if (documentManager) {
                ...
                console.log('[ThemesManager] Saved theme to Yjs:', themeId);
            }
        }
    }
