    ...
    createIdevicesUploadInput() {
        ...
        inputUpload.addEventListener('change', async (e) => {
            ...
            if (isProjectFile) {
                ...
                console.log('[MenuStructure] Importing via Yjs, parentId:', parentId);
                ...
                try {
                    ...
                    if (!bridge || !bridge.documentManager) {
                        throw new Error(_('Yjs not initialized'));
                    }
                    ...
                    console.log('[MenuStructure] Import complete:', stats);
    ...
    async selectNode(element) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (
                ...
                console.log('[MenuStructureBehaviour] About to setNodeSelected, element nav-id:', element?.getAttribute('nav-id'));
                this.deselectNodes();
                this.setNodeSelected(element);
                console.log('[MenuStructureBehaviour] setNodeSelected completed, nodeSelected:', this.nodeSelected?.getAttribute('nav-id'));
                response = element;
...
<path d="M66.4858 113.823C66.6295 113.813 67.1081 112.555 67.1081 112.555L65.5966 117.223L66.0218 112.687C66.0218 112.687 66.3422 113.834 66.4858 113.823Z" fill="#333333"/>
    ...
    setNodeSelected(element) {
        console.log('[MenuStructureBehaviour] setNodeSelected START, element:', element?.getAttribute('nav-id'));
        this.nodeSelected = element;
        this.nodeSelected?.classList.add('selected'); // Collaborative
        console.log('[MenuStructureBehaviour] Added selected class, classList:', this.nodeSelected?.classList.toString());
        ...
        console.log('[MenuStructureBehaviour] Found', allNodes.length, 'nodes to update data-selected, selNavId:', selNavId);
        allNodes.forEach((n) => {
        ...
        console.log('[MenuStructureBehaviour] setNodeSelected END, nodeSelected data-selected:', this.nodeSelected?.getAttribute('data-selected'));
