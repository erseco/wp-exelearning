    ...
    _initPresenceTracking() {
        ...
        const checkReady = () => {
            ...
            if (project?._yjsEnabled && project?._yjsBridge?.getDocumentManager()) {
                ...
                console.log('[MenuStructureCompose] Presence tracking initialized');
            } else {
    ...
    _handlePossiblePageDeletion(previousPageIds) {
        try {
            ...
            if (!selectedNodeInDom) {
                ...
                console.log('[MenuStructureCompose] Selected page was deleted, finding parent...');
                ...
                if (parentNode) {
                    console.log('[MenuStructureCompose] Selecting parent/fallback node');
