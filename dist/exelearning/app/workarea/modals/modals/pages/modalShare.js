...
export default class ModalShare extends Modal {
    ...
    async handleVisibilityChange(newVisibility) {
        // Validate project data before making API call
        if (!this.projectData?.id) {
            console.error('[Share] Cannot update visibility: project data missing id', {
        ...
        console.log('[Share] handleVisibilityChange:', {
        ...
        try {
            ...
            console.log('[Share] updateProjectVisibility response:', response);
